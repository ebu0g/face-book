        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                  child: IconButton(
                      onPressed: () {}, color: Colors.blue, icon: const Icon(Icons.home))),
              Expanded(
                  child: IconButton(
                      onPressed: () {}, color: Colors.black, icon: const Icon(Icons.ondemand_video))),
              Expanded(
                  child: IconButton(
                      onPressed: () {}, color: Colors.black, icon: const Icon(Icons.groups))),
              Expanded(
                  child: IconButton(
                      onPressed: () {}, color: Colors.black, icon: const Icon(Icons.storefront))),
              Expanded(
                  child: IconButton(
                      onPressed: () {}, color: Colors.black, icon: const Icon(Icons.notifications))),
              Expanded(
                  child: IconButton(
                      onPressed: () {}, color: Colors.black, icon: const Icon(Icons.menu))),
            ],
          ),
                  ...
                  SizedBox(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        if (index == 0) return _CreateStoryCard();
...
class _CreateStoryCard extends StatelessWidget {
  //const _CreateStoryCard({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text('Create Story', style: TextStyle(fontWeight: FontWeight.bold)),
        ],
      ),
    );
  }
      ...
      child: Column(
        ...
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            IconButton(iconSize: 18, onPressed: () {}, icon: const Icon(Icons.close))
          ]),
          CircleAvatar(radius: 30, child: const Text('Image')),
